15.5109 19.7695 15.5997 19.7951C15.6885 19.8207 15.7815 19.8282 15.8732 19.817C15.965 19.8059 16.0535 19.7763 16.1336 19.7302C17.9049 18.7962 19.3876 17.3964 20.422 15.6817C21.4563 13.967 22.0029 12.0025 22.0029 10C22.0029 7.99752 21.4563 6.03302 20.422 4.31834C19.3876 2.60365 17.9049 1.20383 16.1336 0.269828Z" fill="white" />
                    </svg>
                </div>
                <div class="col-auto">24/7 Emergency tree Removal available</div>
            </div>
        </div>
    </div>
    <div class="navigation-bar">
        <div class="container">
            <div class="row justify-content-center justify-content-lg-between align-items-center">
                <div class="col-lg-auto logo-bar">
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-auto d-lg-none">
                            <a href="#form" class="btn btn-primary rounded-3 text-white px-4 px-md-5 py-md-4 fs-14">
                                Book Online
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="col-12 col-md-auto py-3 py-md-0">
                            <a href="tel:<?= $phone_number ?>" class="btn fs-7 rounded-0 text-white">
                                <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M15.7331 13.0051C15.7331 13.4224 15.8989 13.8226 16.1939 14.1176C16.489 14.4126 16.8891 14.5784 17.3064 14.5784C17.7236 14.5784 18.1238 14.4126 18.4188 14.1176C18.7139 13.8226 18.8796 13.4224 18.8796 13.0051C18.8796 11.3361 18.2166 9.73548 17.0364 8.55531C15.8563 7.37514 14.2556 6.71213 12.5866 6.71213C12.1694 6.71213 11.7692 6.87789 11.4742 7.17293C11.1791 7.46797 11.0134 7.86813 11.0134 8.28538C11.0134 8.70264 11.1791 9.1028 11.4742 9.39784C11.7692 9.69288 12.1694 9.85863 12.5866 9.85863C13.4211 9.85863 14.2214 10.1901 14.8115 10.7802C15.4016 11.3703 15.7331 12.1706 15.7331 13.0051Z" fill="white" />
                                    <path d="M12.5866 0.419128C12.1694 0.419128 11.7692 0.584881 11.4742 0.879923C11.1791 1.17496 11.0134 1.57513 11.0134 1.99238C11.0134 2.40963 11.1791 2.80979 11.4742 3.10484C11.7692 3.39988 12.1694 3.56563 12.5866 3.56563C15.0894 3.56813 17.4889 4.56345 19.2586 6.33316C21.0283 8.10287 22.0236 10.5024 22.0261 13.0051C22.0261 13.4224 22.1919 13.8226 22.4869 14.1176C22.782 14.4126 23.1821 14.5784 23.5994 14.5784C24.0166 14.5784 24.4168 14.4126 24.7118 14.1176C25.0069 13.8226 25.1726 13.4224 25.1726 13.0051C25.1689 9.66827 23.8417 6.46915 21.4821 4.10962C19.1226 1.7501 15.9235 0.422876 12.5866 0.419128Z" fill="white" />
                                </svg>
        ...
        <div class="d-lg-none py-3 py-lg-0 bg-dark">
            <a href="tel:<?= $phone_number ?>" class="btn fs-7 rounded-0 text-white">
                <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M20.7156 17.7579L16.4411 15.859C15.9969 15.6604 15.4995 15.6144 15.0265 15.7283C14.5535 15.8421 14.1315 16.1094 13.8263 16.4883L12.5945 18.0285C10.5749 16.7326 8.85572 15.0198 7.55221 13.0051L9.09242 11.7733C9.47103 11.4682 9.73806 11.0465 9.8519 10.5738C9.96573 10.1011 9.91996 9.60406 9.72172 9.16011L7.83382 4.87458C7.62203 4.39738 7.24761 4.01093 6.77735 3.78415C6.30708 3.55738 5.77155 3.50502 5.26627 3.63643L1.6478 4.58038C1.12342 4.71685 0.667753 5.04183 0.36793 5.49316C0.0681063 5.94449 -0.054831 6.4905 0.0226276 7.02678C0.696923 11.7068 2.86873 16.0425 6.21299 19.385C9.55725 22.7276 13.8941 24.8972 18.5744 25.5691C19.1108 25.6451 19.6564 25.5207 20.1068 25.2197C20.5573 24.9187 20.881 24.4623 21.0161 23.9377L21.96 20.3192C22.0913 19.814 22.0381 19.2786 21.81 18.8091C21.5819 18.3396 21.1939 17.9669 20.7156 17.7579Z" fill="white" />
                    <path d="M15.7331 13.0051C15.7331 13.4224 15.8989 13.8226 16.1939 14.1176C16.489 14.4126 16.8891 14.5784 17.3064 14.5784C17.7236 14.5784 18.1238 14.4126 18.4188 14.1176C18.7139 13.8226 18.8796 13.4224 18.8796 13.0051C18.8796 11.3361 18.2166 9.73548 17.0364 8.55531C15.8563 7.37514 14.2556 6.71213 12.5866 6.71213C12.1694 6.71213 11.7692 6.87789 11.4742 7.17293C11.1791 7.46797 11.0134 7.86813 11.0134 8.28538C11.0134 8.70264 11.1791 9.1028 11.4742 9.39784C11.7692 9.69288 12.1694 9.85863 12.5866 9.85863C13.4211 9.85863 14.2214 10.1901 14.8115 10.7802C15.4016 11.3703 15.7331 12.1706 15.7331 13.0051Z" fill="white" />
...
<section class="about">
    <div class="container">
        <div class="row justify-content-lg-end">
            <div class="col-lg d-none d-lg-block d-xxl-none"><?= renderImg('about.png', 'background', 'w-100') ?></div>
            <div class="col-lg-6 col-xl-5">
                <div class="sm-heading fs-10 bg-primary text-center text-white">Fully insured</div>
                <div class="hero-heading text-secondary fs-2 pt-3">Wide Selection of<span class="text-primary d-xl-none"> Expert Tree Work</span></div>
                <div class="hero-heading text-primary fs-2 d-none d-xl-block">expert tree work</div>
    ...
    <?= renderImg('about.png', 'background', 'w-100 d-none d-md-block d-lg-none') ?>
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-md-12 col-lg col-xl-4">
                    ...
                    <div class="hero-heading text-primary fs-2 pt-3">Affordable and <span class="text-white d-lg-none">Delivered with a smile</span></div>
                    <div class="hero-heading text-white fs-2 d-none d-lg-block">Delivered with a</div>
                    <div class="hero-heading text-white fs-2 d-none d-lg-block">Smile</div>
                    ...
                    <form action="./src/form" method="POST">
                        ...
                        <div class="row form-row">
                            <div class="col-12">
                                ...
                                <input type="text" placeholder="david citizen" name="name" class="form-control" required>
                            </div>
                            <div class="col-12">
                                <label for="">Your Email</label>
                                <input type="text" placeholder="eg: name@email.com" name="email" class="form-control" required>
                            </div>
                            <div class="col-12">
                                <label for="">Your Message</label>
                                <textarea placeholder="Your message" rows="3" name="comment" class="form-control"></textarea>
                            </div>
                            <div class="col-12">
